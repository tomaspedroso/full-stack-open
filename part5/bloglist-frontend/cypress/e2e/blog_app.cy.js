describe('Blog app', function() {
  ...
  describe('when logged in', function() {
    ...
    describe('and several blog exist', function() {
      beforeEach(function() {
        cy.createBlog({ title: 'blog 1', author: 'author A', url: 'url I', likes: 10 })
        cy.createBlog({ title: 'blog 2', author: 'author B', url: 'url II', likes: 30 })
        cy.createBlog({ title: 'blog 3', author: 'author C', url: 'url III', likes: 20})
        cy.visit('')
      })
